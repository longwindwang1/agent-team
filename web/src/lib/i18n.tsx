...
const zh = {
  ...
  'set.approvalPolicyHint': '仅预算：只有预算/余额类需要你批，危险命令自动放行留痕、选型按推荐自动通过、打回超限自动多给一轮后阻塞、BA 开放问题按合理假设推进',
...
const en: Record<I18nKey, string> = {
  ...
  'set.approvalPolicyHint': 'Budget only: you approve budget/balance items; risky commands auto-allowed with audit events, decisions follow the recommendation, rework overruns get one auto extra round then block, BA open questions proceed on assumptions',
