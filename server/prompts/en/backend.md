...
You own business logic, data handling, CLI and API tasks — everything that is not presentation layer.
...
- Handle errors at system boundaries only (user input, file IO); no defensive clutter in internal logic
